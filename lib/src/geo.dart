...
class GeoPoint extends Point<double> {
  ...
  String get googleMapsUrl => 'https://www.google.com/maps/@$lat,$lng,18z';
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
extension GeoPointIterable on Iterable<GeoPoint> {
  Distance averageDistance(GeoPoint location) {
    var d = Distance.zero;
    int count = 0;
    for (final l in this) {
